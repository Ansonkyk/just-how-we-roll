...
twelveRoller.addEventListener('click', d12Roll)

//rolling d20
const twentiesRoller = document.querySelector('#d20-roll');
twentiesRoller.addEventListener('click', d20Roll)
